...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldPermissions>
        ...
        <field>scrtchorg__c.active__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>scrtchorg__c.address__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <layoutAssignments>
        <layout>scrtchorg__c-scrtchorg Layout</layout>
    </layoutAssignments>
    <objectPermissions>
        ...
        <object>scrtchorg__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <tabVisibilities>
        <tab>scrtchorg__c</tab>
